...
// набора — ≤ 120 с на машине разработчика (docs/spec/simulator.md § 11.2);
// testTimeout здесь (прогон матрицы под нагрузкой всех ядер — десятки секунд) — предохранитель на случай, если один прогон
